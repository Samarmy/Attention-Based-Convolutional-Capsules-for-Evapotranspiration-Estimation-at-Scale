...
class TrainDenseCap():
    ...
    def __init__(self, epochs=300, batch_size=32, torch_type=torch.float32, split=1, trial=1):
        super(TrainDenseCap, self).__init__()
...
if __name__ == '__main__':
    ...
    trainer = TrainDenseCap(split=int(1), trial=int(1))
    trainer.train()
...
#     start_range2 = 1
#     stop_range2 = 101
#     if (socket.gethostname() == "lattice-221"):
#         start_range = 11
#         stop_range = 27   
...
#     if (socket.gethostname() == "lattice-224"):
#         for t in range(start_range2, stop_range2):
#             for r in range(1, 6):
#                 trainer = TrainCNN(split=r, trial=t)
#                 trainer.train()
#                 print("DONE " + str(r) + " SPLIT")
